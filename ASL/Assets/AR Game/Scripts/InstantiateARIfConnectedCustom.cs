...
namespace ASL
{
    ...
    /// </summary>
    public class InstantiateARIfConnectedCustom : MonoBehaviour
    {
        /// <summary>
        /// Called on start
        /// </summary>
        private void Awake()
        {
            ...
            {
                Instantiate(Resources.Load("ASL_Prefabs/ARFoundationPrefabs/ARHolderGameVariant"), Vector3.zero, Quaternion.identity);
